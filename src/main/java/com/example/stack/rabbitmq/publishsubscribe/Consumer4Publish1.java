...
/**
 * @author：yangtao
 * @create: 2022-08-09 15:05
 */
public class Consumer4Publish1 extends DefaultConsumer {

    private final static String QUEUE_NAME = "fanout_queue_1";

    private final static String EXCHANGE_NAME = "fanout_exchange";

    public Consumer4Publish1(Channel channel) {
        super(channel);
    }
    ...
    public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
        //接受从队列中发送的消息
        System.out.println("---------Consumer4Publish1-------收到消息了---------------");
