 ...
 */
public class Consumer4Routing2 extends DefaultConsumer {

    private final static String QUEUE_NAME = "direct_queue_2";

    private final static String EXCHANGE_NAME = "direct_exchange";

    public Consumer4Routing2(Channel channel) {
        super(channel);
    }
    ...
    public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
        //接受从队列中发送的消息
        System.out.println("---------Consumer4Routing2-------收到消息了---------------");
    ...
    public static void main(String[] args) throws Exception {
        ...
        //才起到作用。
        channel.basicQos(1);
        channel.basicConsume(QUEUE_NAME,false,new Consumer4Routing2(channel));
    }
}
